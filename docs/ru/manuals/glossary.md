...
brief: В этом руководстве кратко описаны и перечислены все понятия, с которыми вы столкнётесь при работе в Defold. 
---

# Глоссарий Defold

В этом руководстве кратко описаны все понятия, с которыми вы столкнётесь при работе с Defold. В большинстве случаев, вы так же найдете ссылки, которые ведут к более детальным описаниям или руководствам.

## Animation set

![Animation set](images/icons/animationset.png){.left}Animation set - это ресурс который может содержать в себе список `.dae` или других `.animationset` файлов, из которых можно считывать анимации. Добавление одного Animation set в другой, может быть удобно, если вы хотите частично разделить анимации, между несколькими моделями. Для получения дополнительной информации смотрите руководство [Графика](/manuals/graphics/)

## Atlas

![Atlas](images/icons/atlas.png){.left}Atlas - это набор отдельных изображений, которые скомпилированы в большой лист, для увеличения производительности и уменьшения потребления памяти. Набор может содержать как отдельные статичные изображения, так и серию. Атласы используются многими графическими компонентами такими как: GUI, Sprite, Spine Model и ParticleFX. Более детально - смотрите документацию по [Атлас](/manuals/atlas)

## Builtins

![Builtins](images/icons/builtins.png){.left} Папка проекта builtins - это каталог только для чтения, который содержит множество полезных встроенных ресурсов Defold, доступных для использования. Здесь вы найдете рендерер по умолчанию, скрипт рендеринга, материалы, шрифты и многое другое. Если вам нужно изменить какой-либо ресурс, просто скопируйте их в свой проект и отредактируйте по своему усмотрению.
